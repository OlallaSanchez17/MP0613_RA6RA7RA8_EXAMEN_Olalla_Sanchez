        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <h1 class="h3 mb-0"><i class="fas fa-plus-circle"></i> Create New Pizza</h1>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.pizzas.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="name" id="name" placeholder="Enter pizza name" value="{{ old('name') }}" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="type" id="type" required>
                                        ...
                                        <option value="Pepperoni" {{ old('type') === 'Pepperoni' ? 'selected' : '' }}>Pepperoni</option>
                                        <option value="Hawaiian" {{ old('type') === 'Hawaiian' ? 'selected' : '' }}>Hawaiian</option>
                                        <option value="Veggie" {{ old('type') === 'Veggie' ? 'selected' : '' }}>Veggie</option>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select" name="base" id="base" required>
                                        <option value="" disabled {{ old('base') ? '' : 'selected' }}>--- choose base ---</option>
                                        <option value="Classic" {{ old('base') === 'Classic' ? 'selected' : '' }}>Classic</option>
                                        <option value="Thin" {{ old('base') === 'Thin' ? 'selected' : '' }}>Thin</option>
                                        <option value="Thick" {{ old('base') === 'Thick' ? 'selected' : '' }}>Thick</option>
                                        <option value="Cheesy Crust" {{ old('base') === 'Cheesy Crust' ? 'selected' : '' }}>Cheesy Crust</option>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" rows="3" placeholder="Enter pizza description" required>{{ old('description') }}</textarea>
                            </div>

                            <div class="mb-3">
                                <label class="form-label" for="price">Price ($)</label>
                                <input class="form-control" type="number" name="price" id="price" min="0" step="0.01" value="{{ old('price') }}" placeholder="Enter price" required>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="toppings[]" value="mozzarella" id="mozzarella" {{ in_array('mozzarella', old('toppings', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="toppings[]" value="pepperoni" id="pepperoni" {{ in_array('pepperoni', old('toppings', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="toppings[]" value="basil" id="basil" {{ in_array('basil', old('toppings', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="toppings[]" value="onions" id="onions" {{ in_array('onions', old('toppings', [])) ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" name="image_url" id="image_url" required>
                                    <option value="" disabled {{ old('image_url') ? '' : 'selected' }}>--- choose image ---</option>
                                    @for($i = 1; $i <= 10; $i++)
                                        <option value="/img/pizza{{ $i }}.png" {{ old('image_url') === "/img/pizza{$i}.png" ? 'selected' : '' }}>Pizza {{ $i }}</option>
                                    @endfor
                                </select>
                            </div>
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-primary" type="submit">
                                    <i class="fa-solid fa-save"></i> Create Pizza
                                </button>
